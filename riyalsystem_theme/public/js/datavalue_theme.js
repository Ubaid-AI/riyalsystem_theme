...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(this).on("click", "#header-navbar-change-lang .dropdown-item", function (event) {
            ...
            frappe.call({
                method: "riyalsystem_theme.api.change_language",
                args: {
        ...
        let AppLogoVM = new Vue({
            ...
            methods: {
                get_company_logo: function () {
                    ...
                    frappe.call({
                        type: 'POST',
                        method: 'riyalsystem_theme.api.get_company_logo',
                        args: {},
                        callback: async function (response) {
                            if (response.message && response.message.length) {
                                ...
                                $this.logo_class = '';
                                $this.logo_path = `/assets/riyalsystem_theme/images/${logo}`;
                            }
                        }
                    });
                }
        ...
        new Vue({
            ...
            methods: {
                get_current_language: function () {
                    const $this = this;
                    frappe.call({
                        method: "riyalsystem_theme.api.get_current_language",
                        args: {},
